// Modern (Gen4+) universal item names, index = item ID (0 = None). Shared across Gen4-9 since
// the item ID numbering became stable starting in Generation IV.
export const ITEM_NAMES_MODERN: readonly string[] = [
  "None",
  "Master Ball",
  "Ultra Ball",
  "Great Ball",
